...
- For each category, extract **complete and self-contained phrases** from the text — not just isolated words.
...
- Ignore references, citations, metadata, author affiliations, and publication info.
